...
import { Building2, Coins, Text, Users, Settings, Home } from 'lucide-react';
...
const navigationItems = [
    { label: 'Dashboard', icon: Building2, href: '/dashboard/employer' },
    { label: 'Employees', icon: Users, href: '/dashboard/employer/employees' },
    { label: 'Payments', icon: Coins, href: '/dashboard/employer/payments' },
    { label: 'ESOPS/RSU', icon: Text, href: '/dashboard/employer/esops' },
    { label: 'Settings', icon: Settings, href: '/dashboard/employer/settings' }
];
